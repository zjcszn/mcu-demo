...
int usbd_initialize(void) {
    ...
    static struct xSTATIC_TCB usbd_tx_tcb;
    static StackType_t usbd_tx_stack[CONFIG_USBDEV_TX_STACKSIZE / sizeof(StackType_t)];
    usbd_tx_thread = xTaskCreateStatic(usbdev_tx_thread,
                                       "usbd_tx",
                                       CONFIG_USBDEV_TX_STACKSIZE / sizeof(StackType_t),
                                       NULL,
                                       CONFIG_USBDEV_TX_PRIO,
                                       usbd_tx_stack,
                                       &usbd_tx_tcb);
    ...
    static struct xSTATIC_TCB usbd_rx_tcb;
    static StackType_t usbd_rx_stack[CONFIG_USBDEV_RX_STACKSIZE / sizeof(StackType_t)];
    usbd_rx_thread = xTaskCreateStatic(usbdev_rx_thread,
                                       "usbd_rx",
                                       CONFIG_USBDEV_RX_STACKSIZE / sizeof(StackType_t),
                                       NULL,
                                       CONFIG_USBDEV_RX_PRIO,
                                       usbd_rx_stack,
                                       &usbd_rx_tcb);
