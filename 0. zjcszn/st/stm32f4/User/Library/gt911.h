...
#define GOODIX_USER_CFG_EN               0
#define GOODIX_USER_CFG                  GOODIX_CFG_GROUP1
...
#define Goodix_Delay(ms)                 vTaskDelay(pdMS_TO_TICKS(ms))

// Goodix I2C config
#define GOODIX_I2C_FREQ                  400        // i2c freq

// Goodix I2C sda pin definition
#define GOODIX_SDA_PORT                  GPIOF
#define GOODIX_SDA_PIN                   LL_GPIO_PIN_11

// Goodix I2C scl pin definition
#define GOODIX_SCL_PORT                  GPIOB
#define GOODIX_SCL_PIN                   LL_GPIO_PIN_0

// Goodix INT pin definition
#define GOODIX_INT_PORT                  GPIOB
#define GOODIX_INT_PIN                   LL_GPIO_PIN_1

// Goodix RST pin definition
#define GOODIX_RST_PORT                  GPIOE
#define GOODIX_RST_PIN                   LL_GPIO_PIN_6
