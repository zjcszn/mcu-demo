...
//     <i>Default: 512 bytes
#define ETH1_THREAD_STACK_SIZE  1024

//        Interface Thread Priority
#define ETH1_THREAD_PRIORITY    osPriorityAboveNormal1
