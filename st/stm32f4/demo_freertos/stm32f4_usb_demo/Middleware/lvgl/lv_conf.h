...
#else       /*LV_MEM_CUSTOM*/
#define LV_MEM_CUSTOM_INCLUDE "lwmem/lwmem.h"   /*Header for the dynamic memory function*/
#define LV_MEM_CUSTOM_ALLOC   lwmem_malloc
#define LV_MEM_CUSTOM_FREE    lwmem_free
#define LV_MEM_CUSTOM_REALLOC lwmem_realloc
#endif     /*LV_MEM_CUSTOM*/
