...
/* �����豸�ٶȶ��� */
#define USB_DEV_SPEED_LS        0x01                                    /* ��ǰΪ�����豸 */
...
/** 
  ...
  */
    ...
    UINT32
            ETH_DescriptorSkipLength;        /*!< Specifies the number of word to skip between two unchained descriptors (Ring mode) */
